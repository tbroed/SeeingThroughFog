...
def create_dense_infos(dataset_cfg, class_names, data_path, save_path, workers=cpu_count(), sensor='vlp32'):
    ...
    for time in ['day', 'night']:
        ...
        for condition in ['clear', 'light_fog', 'dense_fog', 'snow']:
            ...
            test_split = f'test_{condition}_{time}{suffix}'
    ...
    for condition in ['clear', 'light_fog', 'dense_fog', 'snow']:
        save_file = f'{pkl_dir}/dense_infos_test_{condition}{suffix}.pkl'

        day_file = f'{pkl_dir}/dense_infos_test_{condition}_day{suffix}.pkl'
        night_file = f'{pkl_dir}/dense_infos_test_{condition}_night{suffix}.pkl'
