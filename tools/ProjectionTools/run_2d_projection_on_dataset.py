...
from tools.ProjectionTools.Lidar2RGB.lib.visi import plot_spherical_scatter_plot, plot_image_projection, get_pc_projection
from tools.DatasetStatisticsTools.lib_stats.util import read_split
...
def parsArgs():
    ...
    parser.add_argument('--root', '-r', help='Enter the root folder', default='../SeeingThroughFogData')
    ...
    parser.add_argument('--frame', '-f', help='frame to project to', default='default')
...
if __name__ == '__main__':
    ...
    args = parsArgs()
    calib_root = './DatasetViewer/calibs'
    ...
    velodyne_to_camera, camera_to_velodyne, P, R, vtc, radar_to_camera, zero_to_camera = load_calib_data(
        calib_root, name_camera_calib='calib_cam_stereo_left.json', tf_tree='calib_tf_tree_full.json',
