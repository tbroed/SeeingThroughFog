    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            if i == 1:
                ...
                ret_dict['unofficial_%s_3d/easy_R40' % class_to_name[curcls]] = mAP3d_R40[j, 0, 1]
                ret_dict['unofficial_%s_3d/moderate_R40' % class_to_name[curcls]] = mAP3d_R40[j, 1, 1]
                ret_dict['unofficial_%s_3d/hard_R40' % class_to_name[curcls]] = mAP3d_R40[j, 2, 1]
                ret_dict['unofficial_%s_bev/easy_R40' % class_to_name[curcls]] = mAPbev_R40[j, 0, 1]
                ret_dict['unofficial_%s_bev/moderate_R40' % class_to_name[curcls]] = mAPbev_R40[j, 1, 1]
                ret_dict['unofficial_%s_bev/hard_R40' % class_to_name[curcls]] = mAPbev_R40[j, 2, 1]
