...
class WaymoDataset(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        def waymo_eval(eval_det_annos, eval_gt_annos):
            ...
            ap_dict['Car_waymo/AP_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_VEHICLE_LEVEL_1/AP')
            ap_dict['Car_waymo/APH_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_VEHICLE_LEVEL_1/APH')
            ap_dict['Car_waymo/AP_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_VEHICLE_LEVEL_2/AP')
            ap_dict['Car_waymo/APH_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_VEHICLE_LEVEL_2/APH')

            ap_dict['Cyclist_waymo/AP_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_CYCLIST_LEVEL_1/AP')
            ap_dict['Cyclist_waymo/APH_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_CYCLIST_LEVEL_1/APH')
            ap_dict['Cyclist_waymo/AP_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_CYCLIST_LEVEL_2/AP')
            ap_dict['Cyclist_waymo/APH_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_CYCLIST_LEVEL_2/APH')

            ap_dict['Pedestrian_waymo/AP_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_1/AP')
            ap_dict['Pedestrian_waymo/APH_L1'] = ap_dict.pop('OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_1/APH')
            ap_dict['Pedestrian_waymo/AP_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_2/AP')
            ap_dict['Pedestrian_waymo/APH_L2'] = ap_dict.pop('OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_2/APH')

            ap_dict.pop('OBJECT_TYPE_TYPE_SIGN_LEVEL_1/AP')
            ap_dict.pop('OBJECT_TYPE_TYPE_SIGN_LEVEL_1/APH')
            ap_dict.pop('OBJECT_TYPE_TYPE_SIGN_LEVEL_2/AP')
            ap_dict.pop('OBJECT_TYPE_TYPE_SIGN_LEVEL_2/APH')
